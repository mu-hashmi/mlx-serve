...
fn ffi_matmul_shape_and_values() {
    ...
    let a = Array::from_slice(
        &[
            0.5_f32, -1.0, 2.0, 0.0, 1.5, -0.5, 0.25, 3.0, 1.0, 0.75, -2.0, 4.0, -1.0, 2.0, 0.5,
            -0.25, 2.5, 1.0, 0.0, -3.0, 1.0, 0.5, -1.5, 2.0, -0.5, 0.0, 1.0, 0.5, -2.5, 3.5, -1.0,
            1.5,
        ],
        &[4, 8],
    );
    let b = Array::from_slice(
        &[
            1.0_f32, 0.0, -1.0, 2.0, 0.5, -0.5, 1.5, 0.0, -1.5, 2.0, 0.0, 1.0, 0.25, -0.75, 2.5,
            -1.0, 1.0, 0.5, -0.5, 3.0, -2.0, 1.0, 0.75, -0.25, 1.25, -1.5, 2.0, 0.5, 0.0, 1.0,
            -2.0, 0.75,
        ],
        &[8, 4],
    );
