...
pub struct GenerationOutput {
    ...
    pub text: String,
    /// Termination reason (`stop` or `length`).
...
pub struct StreamingOutput {
    /// Newly produced text fragment for this step.
    pub new_text: String,
    /// Whether generation has finished at this step.
    pub finished: bool,
    /// Optional finish reason once `finished` is true.
